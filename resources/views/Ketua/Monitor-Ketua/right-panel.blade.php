<div class="flex flex-col border-[4px] border-black bg-black font-sans w-full">
    ...
    <!-- PEMENANG LABEL -->
    <div class="bg-black text-white text-center py-1 text-[10px] font-bold tracking-[0.1em] uppercase">
        Pemenang
    </div>
    ...
    <!-- TIMER LABEL -->
    <div class="bg-black text-white text-center py-1 text-[10px] font-bold tracking-[0.15em] uppercase">
        Timer
    </div>
